...
#define STRING_PROJECTNAME			NSLocalizedString(@"Project Name", nil)
#define STRING_TASKTITLE			NSLocalizedString(@"Task Title", nil)
#define STRING_DEPENDENCYTITLE		NSLocalizedString(@"Dependency Title", nil)
